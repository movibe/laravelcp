...
///echo "Main page - <br> load cart<br>load categories<br>load best selling products";
		$posts = array();
		// Show the page
...
//exit;
	...
	{
	//	echo "You want to see $slug <br> load product based on slug, display cart, display similar items";
//exit;
