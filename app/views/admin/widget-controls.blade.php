<div class="widget-controls pull-right">
	<div class="btn-group">
		<a href="#" class="btn btn-default btn-sm panel-close hide-full glyphicon glyphicon-trash" data-id="{{{ $id }}}"></a>
		...
		<a href="#" class="btn btn-default btn-sm panel-max  glyphicon glyphicon-resize-full" data-id="{{{ $id }}}"></a>
		<a href="#" class="btn btn-default btn-sm panel-hide hide-full glyphicon glyphicon-minus" data-id="{{{ $id }}}"></a>
	</div>	  
</div>